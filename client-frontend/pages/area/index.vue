<template>
  <view class="area-page">
    <view class="area-hero">
      <view>
        <text class="hero-kicker">MY AREA</text>
        <text class="page-title">我的管理区域</text>
        <text class="page-subtitle">查看区域概览、设备状态与浓度趋势。</text>
      </view>
...
.area-hero { display:flex; justify-content:space-between; align-items:flex-end; gap:16rpx; }
