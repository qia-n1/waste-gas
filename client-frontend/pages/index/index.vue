    ...
    async loadOverview() {
      try {
        ...
        if (res && res.code === 200 && res.data) {
          this.realTimeData = {
            vocs: res.data.realTimeData?.vocs ?? this.realTimeData.vocs,
            temperature: res.data.realTimeData?.temperature ?? this.realTimeData.temperature,
            humidity: res.data.realTimeData?.humidity ?? this.realTimeData.humidity,
          };
          this.recentAlerts = Array.isArray(res.data.recentAlerts) ? res.data.recentAlerts : this.recentAlerts;
        }
      } catch (error) {
